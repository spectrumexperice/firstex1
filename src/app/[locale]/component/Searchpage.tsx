...
const Searchpage = () => {
  ...
  return (
    <>
      <Head>
        <title>سبكتروم | ابحث عن منتجات وخدمات</title>
        <meta
          name="description"
          content="ابحث عن منتجات وخدمات سبكتروم بسهولة وسرعة."
        />
      ...
      >
        <noscript>
          <h1>ابحث عن منتجات وخدمات سبكتروم</h1>
          <p>ابحث عن منتجات وخدمات سبكتروم بسهولة وسرعة.</p>
        </noscript>
