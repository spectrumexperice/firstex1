     ...
     >
       ...
       <div className="container mx-auto px-4 sm:px-6 ">
         ...
         >
           ...
           <p className="text-gray-600 max-w-2xl mx-auto font-medium text-lg mt-2 ">
             {t("subtitle")}
           </p>
         </motion.div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
           {services.map((service, index) => (
             ...
             >
               ...
               <div className="p-6 bg-[#b0b0b0]">
                 <div className="flex items-center gap-3 mb-3">
                   <FaTools className="text-[#28a420] text-xl" />
                   <h3 className="text-xl font-[cairo]  font-semibold text-[#6b252f]">
                     {t(service.titleKey)}
                   </h3>
                 </div>
                 ...
                 <div className="space-y-4">
                   ...
                   <button
                     ...
                     className="text-yellow-300 font-medium hover:underline focus:outline-none"
